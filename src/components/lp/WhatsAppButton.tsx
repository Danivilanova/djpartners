...
/**
 * Glifo oficial de WhatsApp (trazado de Simple Icons, CC0; la marca es de
 * WhatsApp LLC y se usa para el fin previsto: enlazar a una conversación).
 * En `currentColor` para respetar la paleta monocroma de la landing.
 */
