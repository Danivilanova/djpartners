  ...
  const features = [
    {
      ...
      image: "/uploads/dvzrei98SlTgRIUuw2_LM_output.webp"
    },
    {
      ...
      image: "/uploads/n2etBtUx9w20MErLuySb__output.webp"
    },
    {
      icon: <TrendingUp className="w-10 h-10 text-white transition-transform duration-300 transform" />,
      title: "Inteligencia de Negocio",
      description: "Convertimos tus datos en decisiones inteligentes que impulsan el crecimiento y la rentabilidad de tu PYME.",
      image: "/uploads/H_MjEEZ4ohH8h5oe7g8a__output.webp"
    },
    {
      ...
      image: "/uploads/05IVr4RZuAi0raqd-QjMS_output.webp"
    }
  ];
            ...
            >
              <div className="absolute inset-0 w-full h-full">
                ...
                <div className={cn(
                  ...
                  isHijacked ? "bg-black/40" : hoveredFeature === index ? "bg-black/50" : "bg-black/70"
                )}></div>
              </div>
