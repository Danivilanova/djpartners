...
const InternalTeamForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error sending internal team request:', error);
      toast({
        title: "Error",
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Forma parte de nuestro equipo con posiciones full-time y part-time en proyectos de transformación digital.
              </p>
            </motion.div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Textarea 
                    id="mensaje"
                    placeholder="Cuéntanos sobre tu motivación para unirte a nuestro equipo, tu experiencia relevante y qué valor puedes aportar a D&J Partners..."
                    rows={6}
                ...
                <div className="pt-4">
                  ...
                  >
                    ...
                    {isSubmitting ? 'Enviando...' : 'Solicitar Trabajar con Nosotros'}
                  </Button>
                </div>
              </form>
            </motion.div>
